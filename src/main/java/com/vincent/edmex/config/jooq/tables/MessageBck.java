...
import com.vincent.edmex.config.jooq.tables.records.MessageBckRecord;
...
public class MessageBck extends TableImpl<MessageBckRecord> {
     ...
     */
    public final TableField<MessageBckRecord, LocalDateTime> CREATED_DATE = createField(DSL.name("created_date"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
